...
- brouter-compatible API so we can use existing frontends (gpx.studio)
...
- [[https://blog.mapbox.com/fast-geodesic-approximations-with-cheap-ruler-106f229ad016][Fast Geodesic Approximation with Cheap Ruler]]
